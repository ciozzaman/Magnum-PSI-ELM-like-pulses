...
from functions.spectools import get_angle,rotate,get_tilt,do_tilt,getFirstBin, binData, get_angle_2,binData_with_sigma
...
limits_wave = [66, 84]
figure_number = 0
where_to_save_everything = '/home/ffederic/work/Collaboratory/test/experimental_data/functions/Calibrations/sensitivity_11/Sensitivity_4_plots_'
...
for iFile, j in enumerate(calib_ID_long):
	...
	temp_sigma = do_tilt_no_lines(temp_sigma)
...
for iFile, j in enumerate(calib_ID):
	...
	temp_sigma = temp_sigma/(df_log.loc[j, ['Calib_ID']][0]*1000000)
	data_all.append(data)
