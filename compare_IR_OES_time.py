...
if print_2:
	...
	plt.plot(np.array(global_dictionary['timestamp_OES_0'])-global_dictionary['timestamp_OES_0'][0],(np.array(global_dictionary['time_of_pulses_IR_0'])-global_dictionary['time_of_pulses_IR_0'][0]),label='time_of_pulses_IR_0')
	plt.plot(np.array(global_dictionary['timestamp_OES_0'])-global_dictionary['timestamp_OES_0'][0],global_dictionary['fit_OES_IR'][1]-global_dictionary['fit_OES_IR'][1,0]-(np.array(global_dictionary['time_of_pulses_IR_0'])-global_dictionary['time_of_pulses_IR_0'][0]),label='fit-time_of_pulses_IR_0')
	plt.legend(loc='best')
	plt.pause(0.01)
	...
	plt.plot(global_dictionary['pressure'],(np.array(global_dictionary['time_of_pulses_IR_0'])-global_dictionary['time_of_pulses_IR_0'][0]),label='time_of_pulses_IR_0')
	plt.plot(global_dictionary['pressure'],global_dictionary['fit_OES_IR'][1]-global_dictionary['fit_OES_IR'][1,0]-(np.array(global_dictionary['time_of_pulses_IR_0'])-global_dictionary['time_of_pulses_IR_0'][0]),label='fit-time_of_pulses_IR_0')
	plt.legend(loc='best')
	plt.pause(0.01)
