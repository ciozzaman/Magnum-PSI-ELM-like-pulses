...
limits_wave = [66, 84]
figure_number = 0
where_to_save_everything = '/home/ffederic/work/Collaboratory/test/experimental_data/functions/Calibrations/sensitivity_4/Sensitivity_4_plots_'
...
for i in range(len(binned_all)):
	...
	# wtDark = np.arange(1, 41) / 41
	# calBinned = longCal_all[i][1:41] - (np.outer(wtDark, topDark) + np.outer(wtDark[::-1], botDark)) + (topDark + botDark) / 2  # MODIFIED TO AVOID NEGATIVE VALUES
	scaled_down_calBinned.append(calBinned_all[i]*calBinned_peak_sum_single / calBinned_peak_sum[i])
...
np.save('/home/ffederic/work/Collaboratory/test/experimental_data/functions/Calibrations/sensitivity_4/Sensitivity_4',to_save)
...
limits_wave = [40,52]
figure_number = 0
where_to_save_everything = '/home/ffederic/work/Collaboratory/test/experimental_data/functions/Calibrations/sensitivity_4/Sensitivity_2_plots_'
...
np.save('/home/ffederic/work/Collaboratory/test/experimental_data/functions/Calibrations/sensitivity_4/Sensitivity_2',to_save)
...
limits_wave = [17,26]
figure_number = 0
where_to_save_everything = '/home/ffederic/work/Collaboratory/test/experimental_data/functions/Calibrations/sensitivity_4/Sensitivity_1_plots_'
...
np.save('/home/ffederic/work/Collaboratory/test/experimental_data/functions/Calibrations/sensitivity_4/Sensitivity_1',to_save)
