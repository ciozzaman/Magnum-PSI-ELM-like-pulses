...
# H(q) + e- → H(p>q) + e-
# n = 2-12
T_e_From_H = PEC_From_H[:,:,0].flatten()
# Te_HmH2p_N = np.repeat(Te_HmH2p_N,len(excited_states)).reshape((len(Te_HmH2p_N),len(excited_states))).T.flatten()
T_H_From_H = PEC_From_H[:,:,1].flatten()
n_e_From_H = PEC_From_H[:,:,2].flatten()
n_Hp_From_H = PEC_From_H[:,:,3].flatten()
n_H_From_H = PEC_From_H[:,:,4].flatten()
PEC_val_From_H = PEC_From_H[:,:,5].flatten()
...
excited_states_From_H = np.repeat(excited_states_From_H,len(PEC_From_H[0]))

From_H_pop_coeff = interpolate.LinearNDInterpolator(np.log(np.array([excited_states_From_H, T_e_From_H, T_H_From_H, n_e_From_H, n_Hp_From_H,n_H_From_H]).T),np.log(PEC_val_From_H))
def From_H_pop_coeff_full(x,function=From_H_pop_coeff,excited_states=excited_states_From_H, coord_1=T_e_From_H, coord_2=T_H_From_H, coord_3=n_e_From_H, coord_4=n_Hp_From_H, coord5=n_H_From_H):
	import numpy as np
	x=np.array(x)
	...
	x[x[:,5]<np.min(coord_5),5]=np.min(coord_5)
	x[x[:,5]>np.max(coord_5),5]=np.max(coord_5)
...
# H+ + 2e- → H(p) + e-
# n = 2-12
T_e_From_Hp = PEC_From_Hp[:,:,0]
T_Hp_From_Hp = PEC_From_Hp[:,:,1]
T_H_From_Hp = PEC_From_Hp[:,:,2]
n_e_From_Hp = PEC_From_Hp[:,:,3]
n_Hp_From_Hp = PEC_From_Hp[:,:,4]
PEC_val_From_Hp = PEC_From_Hp[:,:,5]
...
excited_states_From_Hp = np.repeat(excited_states_From_Hp,len(PEC_From_Hp[0]))

From_Hp_pop_coeff = interpolate.LinearNDInterpolator(np.log(np.array([excited_states_From_Hp, T_e_From_Hp, T_Hp_From_Hp, T_H_From_Hp,n_e_From_Hp,n_Hp_From_Hp]).T),np.log(PEC_val_From_Hp))
def HmHp_N_pop_coeff_full(x,function=From_Hp_pop_coeff,excited_states=excited_states_From_Hp, coord_1=T_e_From_Hp, coord_2=T_Hp_From_Hp, coord_3=T_H_From_Hp, coord_4=n_e_From_Hp, coord_5=n_Hp_From_Hp):
	import numpy as np
	x = np.array(x)
	x[x[:, 0] < np.min(excited_states), 0] = np.min(excited_states)
	x[x[:, 0] > np.max(excited_states), 0] = np.max(excited_states)
...
# H+ + H- → H(p) + H
# n = 2-12
T_e_From_Hn_with_Hp = PEC_From_Hn_with_Hp[:,:,0]
T_Hp_From_Hn_with_Hp = PEC_From_Hn_with_Hp[:,:,1]
T_Hm_From_Hn_with_Hp = PEC_From_Hn_with_Hp[:,:,2]
T_H_From_Hn_with_Hp = PEC_From_Hn_with_Hp[:,:,3]
n_e_From_Hn_with_Hp = PEC_From_Hn_with_Hp[:,:,4]
n_Hm_From_Hn_with_Hp = PEC_From_Hn_with_Hp[:,:,5]
PEC_val_From_Hn_with_Hp = PEC_From_Hn_with_Hp[:,:,6]
n_Hp_From_Hn_with_Hp = 0	# #/m^3
# T_H_HmHp_N = 8000/11600	#K

excited_states_Hn_with_Hp=len(PEC_From_Hn_with_Hp)
excited_states_Hn_with_Hp = np.linspace(2,2+excited_states_Hn_with_Hp-1,excited_states_Hn_with_Hp).astype('int')
excited_states_Hn_with_Hp = np.repeat(excited_states_Hn_with_Hp,len(PEC_From_Hn_with_Hp[0]))

HmHp_N_pop_coeff = interpolate.LinearNDInterpolator(np.log(np.array([excited_states_Hn_with_Hp, T_e_From_Hn_with_Hp, T_Hp_From_Hn_with_Hp, T_Hm_From_Hn_with_Hp,T_H_From_Hn_with_Hp,n_e_From_Hn_with_Hp,n_Hm_From_Hn_with_Hp]).T),np.log(PEC_val_From_Hn_with_Hp))
def HmHp_N_pop_coeff_full(x,function=HmHp_N_pop_coeff,excited_states=excited_states_Hn_with_Hp, coord_1=T_e_From_Hn_with_Hp, coord_2=T_Hp_From_Hn_with_Hp, coord_3=T_Hm_From_Hn_with_Hp, coord_4=T_H_From_Hn_with_Hp, coord_5=n_e_From_Hn_with_Hp, coord_6=n_Hm_From_Hn_with_Hp):
	import numpy as np
	x = np.array(x)
	x[x[:, 0] < np.min(excited_states), 0] = np.min(excited_states)
	x[x[:, 0] > np.max(excited_states), 0] = np.max(excited_states)
	...
	x[x[:,6]<np.min(coord_6),6]=np.min(coord_6)
	x[x[:,6]>np.max(coord_6),6]=np.max(coord_6)
...
# H2+ + H- → H(p) + H2
# n = 2-12
T_e_From_Hn_with_H2p = PEC_From_Hn_with_H2p[:,:,0].flatten()
# Te_HmH2p_N = np.repeat(Te_HmH2p_N,len(excited_states)).reshape((len(Te_HmH2p_N),len(excited_states))).T.flatten()
T_H2p_From_Hn_with_H2p = PEC_From_Hn_with_H2p[:,:,1].flatten()
T_Hm_From_Hn_with_H2p = PEC_From_Hn_with_H2p[:,:,2].flatten()
T_H_From_Hn_with_H2p = PEC_From_Hn_with_H2p[:,:,3].flatten()
n_e_From_Hn_with_H2p = PEC_From_Hn_with_H2p[:,:,4].flatten()
n_H2p_From_Hn_with_H2p = PEC_From_Hn_with_H2p[:,:,5].flatten()
n_Hm_From_Hn_with_H2p = PEC_From_Hn_with_H2p[:,:,6].flatten()
PEC_val_From_Hn_with_H2p = PEC_From_Hn_with_H2p[:,:,7].flatten()
# n_H2p_HmH2p_N = 1.0000e+15	# #/m^3
# T_H_HmH2p_N = 50000/11600	#K
...
excited_states_From_Hn_with_H2p = np.repeat(excited_states_From_Hn_with_H2p,len(PEC_From_Hn_with_H2p[0]))

HmH2p_N_pop_coeff = interpolate.LinearNDInterpolator(np.log(np.array([excited_states_From_Hn_with_H2p, T_e_From_Hn_with_H2p, T_H2p_From_Hn_with_H2p, T_Hm_From_Hn_with_H2p, T_H_From_Hn_with_H2p,n_e_From_Hn_with_H2p,n_H2p_From_Hn_with_H2p,n_Hm_From_Hn_with_H2p]).T),np.log(PEC_val_HmH2p_N))
def HmH2p_N_pop_coeff_full(x,function=HmH2p_N_pop_coeff,excited_states=excited_states_From_Hn_with_H2p, coord_1=T_e_From_Hn_with_H2p, coord_2=T_H2p_From_Hn_with_H2p, coord_3=T_Hm_From_Hn_with_H2p, coord_4=T_H_From_Hn_with_H2p, coord_5=n_e_From_Hn_with_H2p, coord_6=n_H2p_From_Hn_with_H2p, coord_7=n_Hm_From_Hn_with_H2p):
	import numpy as np
	x=np.array(x)
	x[x[:,0]<np.min(excited_states),0]=np.min(excited_states)
	x[x[:,0]>np.max(excited_states),0]=np.max(excited_states)
	...
	x[x[:,7]<np.min(coord_7),7]=np.min(coord_7)
	x[x[:,7]>np.max(coord_7),7]=np.max(coord_7)
