...
def RR_Hp_H_H__H_H2__r(merge_Te_prof_multipulse_interp_crop_limited,T_H,T_Hp,merge_ne_prof_multipulse_interp_crop_limited):
	if np.shape(merge_Te_prof_multipulse_interp_crop_limited)!=np.shape(merge_ne_prof_multipulse_interp_crop_limited):
		print('error, Te and ne are different shapes')
		exit()
	if np.shape(merge_Te_prof_multipulse_interp_crop_limited)==():
	...
	reaction_rate = 1.145/(( temperature )**1.12) *1e-29 * (1e-6 * 1e-6* 1e20)	# m^6/s * 1e20
	...
	Hp_H_H__H_H2 = merge_ne_prof_multipulse_interp_crop_limited*reaction_rate
	return Hp_H_H__H_H2
...
def RR_rate_destruction_Hp(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_H,T_H2,T_Hm,T_H2p,merge_ne_prof_multipulse_interp_crop_limited,nHp_ne_all,nH_ne_all,nH2_ne_all,nHm_ne_all,nH2p_ne_all,fractional_population_states_H2,nH_all_ground_state,population_states,molecular_precision,atomic_precision):
	if (len(np.unique(merge_Te_prof_multipulse_interp_crop_limited))==1 and len(np.unique(merge_ne_prof_multipulse_interp_crop_limited))==1):
		...
		out_sigma = ((molecular_precision*nHm_ne_all*RR_Hp_Hm__Hex_H(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_Hm,merge_ne_prof_multipulse_interp_crop_limited,nHp_ne_all))**2 + (molecular_precision*nHm_ne_all*nHp_ne_all*RR_Hp_Hm__H2p_e__r(Te,np.unique(T_Hp),np.unique(T_Hm),ne)[0])**2 + (molecular_precision*nHp_ne_all*nH2_ne_all*RR_Hp_H2X1Σg__H1s_H2pX2Σg__r(Te,np.unique(T_H2),np.unique(T_Hp),ne)[0])**2 + (molecular_precision*nHp_ne_all*(nH_all_ground_state**2)*RR_Hp_H_H__H_H2p__r(Te,np.unique(T_Hp),np.unique(T_H),ne)[0])**2 + (molecular_precision*2*nHp_ne_all*(nH_all_ground_state**2)*RR_Hp_H_H__H_H2__r(Te,np.unique(T_H),np.unique(T_Hp),ne)[0])**2 + (atomic_precision*nHp_ne_all*RR_recombination__r(Te,ne)[0])**2)**0.5
	else:
		# return nHm_ne_all*nHp_ne_all*RR_Hp_Hm__H_2_H__r(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_Hm,merge_ne_prof_multipulse_interp_crop_limited) + nHm_ne_all*nHp_ne_all*RR_Hp_Hm__H_3_H__r(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_Hm,merge_ne_prof_multipulse_interp_crop_limited) + nHm_ne_all*nHp_ne_all*RR_Hp_Hm__H2p_e__r(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_Hm,merge_ne_prof_multipulse_interp_crop_limited) + nHp_ne_all*nH2_ne_all*RR_Hp_H2X1Σg__H1s_H2pX2Σg__r(merge_Te_prof_multipulse_interp_crop_limited,T_H2,T_Hp,merge_ne_prof_multipulse_interp_crop_limited) + nHp_ne_all*(nH_all_ground_state**2)*RR_Hp_H_H__H_H2p__r(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_H,merge_ne_prof_multipulse_interp_crop_limited)+ 2*nHp_ne_all*(nH_all_ground_state**2)*RR_Hp_H_H__H_H2__r(merge_Te_prof_multipulse_interp_crop_limited,T_H,T_Hp,merge_ne_prof_multipulse_interp_crop_limited) + nHp_ne_all*RR_recombination__r(merge_Te_prof_multipulse_interp_crop_limited,merge_ne_prof_multipulse_interp_crop_limited)
		out = nHm_ne_all*RR_Hp_Hm__Hex_H(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_Hm,merge_ne_prof_multipulse_interp_crop_limited,nHp_ne_all) + nHm_ne_all*nHp_ne_all*RR_Hp_Hm__H2p_e__r(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_Hm,merge_ne_prof_multipulse_interp_crop_limited) + nHp_ne_all*nH2_ne_all*RR_Hp_H2X1Σg__H1s_H2pX2Σg__r(merge_Te_prof_multipulse_interp_crop_limited,T_H2,T_Hp,merge_ne_prof_multipulse_interp_crop_limited) + nHp_ne_all*(nH_all_ground_state**2)*RR_Hp_H_H__H_H2p__r(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_H,merge_ne_prof_multipulse_interp_crop_limited)+ 2*nHp_ne_all*(nH_all_ground_state**2)*RR_Hp_H_H__H_H2__r(merge_Te_prof_multipulse_interp_crop_limited,T_H,T_Hp,merge_ne_prof_multipulse_interp_crop_limited) + nHp_ne_all*RR_recombination__r(merge_Te_prof_multipulse_interp_crop_limited,merge_ne_prof_multipulse_interp_crop_limited)
		out_sigma = ((molecular_precision*nHm_ne_all*RR_Hp_Hm__Hex_H(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_Hm,merge_ne_prof_multipulse_interp_crop_limited,nHp_ne_all))**2 + (molecular_precision*nHm_ne_all*nHp_ne_all*RR_Hp_Hm__H2p_e__r(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_Hm,merge_ne_prof_multipulse_interp_crop_limited))**2 + (molecular_precision*nHp_ne_all*nH2_ne_all*RR_Hp_H2X1Σg__H1s_H2pX2Σg__r(merge_Te_prof_multipulse_interp_crop_limited,T_H2,T_Hp,merge_ne_prof_multipulse_interp_crop_limited))**2 + (molecular_precision*nHp_ne_all*(nH_all_ground_state**2)*RR_Hp_H_H__H_H2p__r(merge_Te_prof_multipulse_interp_crop_limited,T_Hp,T_H,merge_ne_prof_multipulse_interp_crop_limited))**2 + (molecular_precision*2*nHp_ne_all*(nH_all_ground_state**2)*RR_Hp_H_H__H_H2__r(merge_Te_prof_multipulse_interp_crop_limited,T_H,T_Hp,merge_ne_prof_multipulse_interp_crop_limited))**2 + (atomic_precision*nHp_ne_all*RR_recombination__r(merge_Te_prof_multipulse_interp_crop_limited,merge_ne_prof_multipulse_interp_crop_limited))**2)**0.5
	return out,out_sigma
...
if False:# up to 06/10/2020. Ray gave me new and better data and I adapted this correlations
	...
	nH2_ne_fit_from_simulations = interpolate.interp1d(np.log(temp),np.log(temp2),fill_value='extrapolate')
	TH2_fit_from_simulations = interpolate.interp1d(np.log([1e-5,0.1,2,4]),np.log([0.99e-5,0.099,0.3,0.3]),fill_value='extrapolate')
